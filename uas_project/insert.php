<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        if (move_uploaded_file($gambar['tmp_name'], $path)) {
            ...
            $sql = "INSERT INTO data_produk (Nama, Harga, Deskripsi, Tags, Kategori, Gambar) Values ('$nama','$harga','$deskripsi','$tags','$kategori','$namagambar')";

            $query = mysqli_query($conn, $sql);

            if (!$query) {
                echo "<script>alert('Insert Produk Gagal !!!')</script>";
                exit;
            }
...
<body>
    ...
    <script src="validasi_insert.js"></script>
</body>
</html>